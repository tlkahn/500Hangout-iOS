...
class InsetViewController: BaseContainerViewController {
  // MARK: - Properties
  fileprivate let backgroundViewController: UIViewController
  fileprivate let contentViewController: UIViewController
  fileprivate(set) var hasMargin = false
  fileprivate var parallax: UIMotionEffectGroup!
  ...
  fileprivate func initializeParallax() {
    // Set vertical effect
  ...
  fileprivate func transitionToSize(_ size: CGSize, traitCollection: UITraitCollection,
  ...
  fileprivate static func viewControllerSize(_ controllersPreferredSize: CGSize, size: CGSize,
