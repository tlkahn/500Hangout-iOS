...
class BackgroundMapViewController: UIViewController, CAAnimationDelegate {
  ...
  fileprivate var reduceMotionChanged: NotificationObserver<BackgroundMapViewController>?
  fileprivate var lowPowerModeChanged: NotificationObserver<BackgroundMapViewController>?
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    if #available(iOS 8.0, *) {
      ...
      reduceMotionChanged = NotificationObserver(name: notificationName.rawValue, target: self,
    ...
    if #available(iOS 9.0, *) {
      ...
      lowPowerModeChanged = NotificationObserver(name: notificationName.rawValue, target: self,
                                                 action: type(of: self).restartAnimation)
    }
  }
  ...
  func restartAnimation(_ notification: Notification) {
