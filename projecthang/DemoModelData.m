...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.incomingBubbleImageData = [bubbleFactory incomingMessagesBubbleImageWithColor: themeColor]; //[UIColor jsq_messageBubbleGreenColor]];
    }
...
- (void)addAudioMediaMessage
{
    ...
    NSString * sample;
    if (r==0) {
       sample  = [[NSBundle mainBundle] pathForResource:@"jsq_messages_sample" ofType:@"m4a"];
    }
    else {
        sample = [[NSBundle mainBundle] pathForResource:@"crazy_messages_sample" ofType:@"m4a"];
    }
