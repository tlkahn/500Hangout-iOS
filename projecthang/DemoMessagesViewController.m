...
- (void)viewDidLoad
{
    ...
    NSURL* url = [[NSURL alloc] initWithString:@"http://localhost:3001"];
...
//        [_socket emit:@"subscribe" withItems:@[@(123)]];
    }];
    
    [_socket on:@"conversation private post" callback:^(NSArray * data, SocketAckEmitter * socketAckEmitter) {
        NSLog(@"get private host%@", data[0]);
        JSQMessage* newMessage = [JSQMessage messageWithSenderId:@"707-8956784-57"
                                         displayName:self.demoData.users[@"707-8956784-57"]
                                                text:data[0][@"message"]];
                      ...
                      date:(NSDate *)date
{
     ...
     */
//    [_socket emit:@"send message" withItems:@[@{
//                                                  @"room": @(123),
//                                                  @"message": text
//                                                  }]];
